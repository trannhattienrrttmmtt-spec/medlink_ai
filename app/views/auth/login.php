        ...
        <div class="ml-auth-card-override">
            <div class="ml-brand center" style="flex-direction: column; text-align: center; gap: 8px; margin-bottom: 24px;">
                ...
                <div>
                    ...
                    <p style="color: #94a3b8; font-size: 12.5px; font-weight: 500;">Hệ thống dự đoán liên kết Thuốc & Bệnh</p>
                </div>
            </div>
            ...
            <form class="ml-form" method="POST" action="index.php?action=do_login">
                <div class="ml-field">
                    ...
                    <div class="input-group">
                        ...
                        <input name="username" required autofocus placeholder="admin hoặc user">
                    </div>
                </div>
                ...
                <button class="ml-btn primary full" type="submit" style="margin-top: 8px; height: 46px;">
                    Đăng nhập <i class="bi bi-box-arrow-in-right" style="font-size: 16px;"></i>
                </button>
            </form>
            
            <p class="ml-footer-note" style="color: #94a3b8;">Chưa có tài khoản? <a href="index.php?action=register">Đăng ký ngay</a></p>
        </div>
    </div>
</div>
